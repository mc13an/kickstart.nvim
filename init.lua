if not vim.g.vscode then
  ...
  -- for people to discover.eetherwise, you normally need to press <C-\><C-n>, which
  ...
  -- NOTE: These keymaps are replaced by vim-tmux-navigator plugin
  ...
  require('lazy').setup({
    ...
    -- you do for a plugin at the top levelq, you can do for a dependency.
    --
